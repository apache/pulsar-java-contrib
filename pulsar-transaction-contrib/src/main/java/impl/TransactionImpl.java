...
public class TransactionImpl implements Transaction {
    ...
    public CompletableFuture<Void> ackAllReceivedMsgsAsync(Consumer<?> consumer) {
        List<MessageId> messageIds = receivedMessages.get(consumer);
        if (messageIds != null) {
    ...
    @Override
    public void ackAllReceivedMsgs(Consumer<?> consumer) throws ExecutionException, InterruptedException {
