        ...
        mcpServer.addTool(McpServerFeatures.SyncToolSpecification.builder()
                ...
                .callHandler((exchange, request) -> {
                    try {
                        ...
                        details.put("backlogQuotaMap", pulsarAdmin.namespaces().getBacklogQuotaMap(fullNamespace));
                        details.put("retention", pulsarAdmin.namespaces().getRetention(fullNamespace));
                        details.put("persistence", pulsarAdmin.namespaces().getPersistence(fullNamespace));
                        details.put("maxConsumersPerSubscription",
                                pulsarAdmin.namespaces().
                                        getMaxConsumersPerSubscription(fullNamespace));
                        details.put("maxConsumersPerTopic",
                                pulsarAdmin.namespaces().
                                        getMaxConsumersPerTopic(fullNamespace));
                        details.put("maxProducersPerTopic",
                                pulsarAdmin.namespaces().
                    ...
                    try {
                        ...
                        switch (policyStr.toLowerCase()) {
                            ...
                            case "consumer_backlog_eviction":
                                ...
                                break;
                            default:
                                return createErrorResult("Invalid policy:"
                                                + policyStr,
                                        List.of("Valid policies: producer_request_hold, "
                        ...
                        if (subscriptionName != null && !subscriptionName.trim().isEmpty()) {
                            pulsarAdmin.namespaces()
                                    .clearNamespaceBacklogForSubscription(
                                            fullNamespace, subscriptionName);
                        } else {
        ...
        mcpServer.addTool(McpServerFeatures.SyncToolSpecification.builder()
                ...
                .callHandler((exchange, request) -> {
                    try {
                        ...
                        long nonPersistentTopics = topics.stream().filter(t ->
                                t.startsWith("non-persistent://")).count();
