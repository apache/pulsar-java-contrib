...
public class BasePulsarToolsTest {
  ...
  public void getRequiredStringParam_shouldReturnValue_whenKeyExistsAndNotEmpty() {
    ...
    org.testng.Assert.assertEquals(
        testTools.getRequiredStringParam(params, "testKey"), "testValue");
    ...
    try {
      ...
      org.testng.Assert.assertTrue(
          e.getMessage().contains("Required parameter 'emptyKey' is missing"));
    }
    ...
    try {
      ...
      org.testng.Assert.assertTrue(
          e.getMessage().contains("Required parameter 'nullKey' is missing"));
    }
    ...
    try {
      ...
      org.testng.Assert.assertTrue(
          e.getMessage().contains("Required parameter 'nonExistentKey' is missing"));
    }
  }
  ...
  public void getIntParam_shouldReturnValue_whenKeyExists() {
    ...
    org.testng.Assert.assertEquals(
        testTools.getIntParam(params, "stringKey", 0), Integer.valueOf(123));
    org.testng.Assert.assertEquals(
        testTools.getIntParam(params, "doubleKey", 0), Integer.valueOf(45));
    org.testng.Assert.assertEquals(testTools.getIntParam(params, "nullKey", 0), Integer.valueOf(0));
    org.testng.Assert.assertEquals(
        testTools.getIntParam(params, "nonExistentKey", 0), Integer.valueOf(0));
  }
  ...
  public void getIntParam_shouldReturnDefault_whenInvalidFormat() {
    ...
    org.testng.Assert.assertEquals(
        testTools.getIntParam(params, "invalidKey", 0), Integer.valueOf(0));
  }
  ...
  public void getBooleanParam_shouldReturnValue_whenKeyExists() {
    ...
    org.testng.Assert.assertEquals(
        testTools.getBooleanParam(params, "boolKey", false), Boolean.TRUE);
    org.testng.Assert.assertEquals(
        testTools.getBooleanParam(params, "stringKey", false), Boolean.TRUE);
    org.testng.Assert.assertEquals(
        testTools.getBooleanParam(params, "nullKey", false), Boolean.FALSE);
    org.testng.Assert.assertEquals(
        testTools.getBooleanParam(params, "nonExistentKey", false), Boolean.FALSE);
  }
  ...
  public void getLongParam_shouldReturnValue_whenKeyExists() {
    ...
    org.testng.Assert.assertEquals(
        testTools.getLongParam(params, "longKey", 0L), Long.valueOf(123L));
    org.testng.Assert.assertEquals(
        testTools.getLongParam(params, "intKey", 0L), Long.valueOf(456L));
    org.testng.Assert.assertEquals(
        testTools.getLongParam(params, "stringKey", 0L), Long.valueOf(789L));
    org.testng.Assert.assertEquals(testTools.getLongParam(params, "nullKey", 0L), Long.valueOf(0L));
    org.testng.Assert.assertEquals(
        testTools.getLongParam(params, "nonExistentKey", 0L), Long.valueOf(0L));
  }
  ...
  public void getLongParam_shouldReturnDefault_whenInvalidFormat() {
    ...
    org.testng.Assert.assertEquals(
        testTools.getLongParam(params, "invalidKey", 0L), Long.valueOf(0L));
  }
