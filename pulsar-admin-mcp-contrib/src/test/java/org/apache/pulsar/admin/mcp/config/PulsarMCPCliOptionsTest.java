...
public class PulsarMCPCliOptionsTest {
  ...
  @Test(
      ...
      expectedExceptionsMessageRegExp =
          ".*invalid is not a valid TransportType.*Valid Options: stdio,http.*")
  ...
  public void toString_shouldReturnCorrectFormat() throws Exception {
    ...
    java.lang.reflect.Field transportField =
        PulsarMCPCliOptions.class.getDeclaredField("transport");
