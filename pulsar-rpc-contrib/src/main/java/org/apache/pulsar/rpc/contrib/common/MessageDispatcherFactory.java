...
/**
 * Facilitates the creation of producers and consumers for Pulsar based on specified schemas and
 * configurations. This factory simplifies the setup of Pulsar clients for sending and receiving
...
public class MessageDispatcherFactory<T, V> {
   ...
   */
  public Producer<T> requestProducer(String topic, Map<String, Object> requestProducerConfig)
      throws IOException {
    return client
   ...
   */
  public Consumer<V> replyConsumer(
      String topic,
      MessageListener<V> listener,
      Pattern topicsPattern,
      Duration patternAutoDiscoveryInterval)
      throws IOException {
    ConsumerBuilder<V> replyConsumerBuilder =
        client
    ...
    return topicsPattern == null
        ? replyConsumerBuilder.topic(topic).subscribe()
  ...
  public Consumer<T> requestConsumer(
    ...
    ConsumerBuilder<T> consumerBuilder =
        client
            ...
            .messageListener(listener);
    return topicsPattern == null
        ? consumerBuilder.topic(topic).subscribe()
