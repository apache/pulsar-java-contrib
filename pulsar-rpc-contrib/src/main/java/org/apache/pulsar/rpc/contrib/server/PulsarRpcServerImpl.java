...
class PulsarRpcServerImpl<T, V> implements PulsarRpcServer<T, V> {
    ...
    /**
     * Creates a new instance of {@link PulsarRpcServerImpl} using the specified Pulsar client and configuration.
    ...
    static <T, V> PulsarRpcServerImpl<T, V> create(
            ...
            @NonNull PulsarRpcServerBuilderImpl<T, V> builder) throws PulsarRpcServerException {
        ...
        try {
            requestConsumer = dispatcherFactory.requestConsumer(
        ...
        return new PulsarRpcServerImpl<>(
                requestConsumer,
                pool
        );
    }
