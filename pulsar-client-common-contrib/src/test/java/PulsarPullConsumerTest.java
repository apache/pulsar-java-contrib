...
public class PulsarPullConsumerTest {
    ...
    public void setup() throws Exception {
        try {
            ...
            log.info("Topics already exist, skipping creation: {}, {}", nonPartitionedTopic, partitionedTopic);
        }
    }
    ...
    /**
     * Case test design:
     * 1. Single partition topicA
     * 1. Send one thousand messages
     * 2. Create a PullConsumer, subscribe to topicA, and pull messages.
     * 3. Verify message Exactly-once
     * 4. Verify message consumption status
     * 2. Multi-partition topicB
     * 1. Send one thousand messages
     * 3. Create multiple PullConsumers and subscribe to each partition of topicB.
     * 4. Each PullConsumer pulls messages and verifies that the message is Exactly-once.
     * 5. Verify message consumption status
     */
